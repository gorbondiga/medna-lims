...
LOGIN_URL = 'dashboard'  # defaults to /accounts/login, which doesn't exist
...
LEAFLET_CONFIG = dict({
    ...
    # 'MIN_ZOOM': None,
    # 'MAX_ZOOM': None,
    'DEFAULT_CENTER': (43, -2),  # Latitude ,  Longitude
    'DEFAULT_PRECISION': 6,
...
APP_ORDER = OrderedDict([
    ...
    ('field_survey', ['EnvMeasureType', 'FieldSurvey', 'FieldCrew', 'EnvMeasurement',
