...
class SamplingMethods(models.TextChoices):
    HAND = 'hand', _('By Hand')
    PLANKTON_NET = 'plankton_net', _('Plankton Net')
    __empty__ = _('(Unknown)')
...
class WatershedTypes(models.TextChoices):
    COASTAL = 'coastal', _('Coastal')
    RIVERINE = 'riverine', _('Riverine')
    LACUSTRINE = 'lacustrine', _('Lacustrine')
    ESTUARINE = 'estuarine', _('Estuarine')
    WETLAND = 'wetland', _('Wetland')
    URBAN = 'urban', _('Urban')
    AGRICULTURAL = 'agricultural', _('Agricultural')
    FORESTED = 'forested', _('Forested')
    __empty__ = _('(Unknown)')
