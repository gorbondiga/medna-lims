...
def get_sentinel_user():
    ...
    obj, created = get_user_model().objects.get_or_create(email='deleted@user.com')
    return obj.pk


def get_default_user():
    obj, created = get_user_model().objects.get_or_create(email='default@user.com')
    return obj.pk


def get_default_process_location():
    obj, created = ProcessLocation.objects.get_or_create(process_location_name='eDNA Laboratory (UMaine CORE)',
...
class DateTimeUserMixin(models.Model):
    ...
    modified_datetime = models.DateTimeField('Modified DateTime', 
                                             auto_now=True,
                                             blank=True,
                                             null=True)
    created_datetime = models.DateTimeField('Created DateTime', 
                                            auto_now_add=True) 
