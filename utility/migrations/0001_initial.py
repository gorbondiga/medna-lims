    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_datetime', models.DateTimeField(auto_now=True, null=True, verbose_name='Modified DateTime')),
                ('created_datetime', models.DateTimeField(auto_now_add=True, verbose_name='Created DateTime')),
                ('default_css_label', models.CharField(max_length=255, unique=True, verbose_name='Default CSS Label')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replied_datetime', models.DateTimeField(blank=True, null=True, verbose_name='Replied DateTime')),
                ('created_by', models.ForeignKey(default=utility.models.get_default_user, on_delete=models.SET(utility.models.get_sentinel_user), to=settings.AUTH_USER_MODEL)),
            ],
            options={
