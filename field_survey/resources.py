...
class EnvMeasureTypeAdminResource(resources.ModelResource):
    class Meta:
        ...
        fields = ('env_measure_type_code', 'env_measure_type_name', 'env_measure_type_unit',
                  'created_by', 'created_datetime', 'modified_datetime', )
        export_order = ('env_measure_type_code', 'env_measure_type_name', 'env_measure_type_unit',
                        'created_by', 'created_datetime', 'modified_datetime', )
...
class EnvMeasureAdminResource(resources.ModelResource):
    class Meta:
        # SampleBarcode
        model = EnvMeasure
        ...
        fields = ('env_global_id', 'env_measure_datetime', 'env_measure_depth', 'env_instrument',
                  ...
                  'env_niskin_notes', 'env_inst_other', 'env_measure_type', 'env_flow_rate', 'env_water_temp',
...
class FieldSampleAdminResource(resources.ModelResource):
    class Meta:
        # SampleBarcode
        model = FieldSample
        import_id_fields = ('field_sample_barcode', 'sample_global_id', 'survey_global_id', )
        fields = ('sample_global_id', 'field_sample_barcode', 'barcode_slug', 'is_extracted',
                  'sample_material', 'survey_global_id',
                  'created_by', 'created_datetime', 'modified_datetime', )
...
class FilterSampleAdminResource(resources.ModelResource):
    class Meta:
        ...
        fields = ('field_sample', 'is_prefilter', 'filter_fname', 'filter_lname', 
                  ...
                  'created_by', 'created_datetime', 'modified_datetime', )
        export_order = ('field_sample', 'is_prefilter', 'filter_fname', 'filter_lname', 
                        'filter_datetime', 'filter_protocol', 'filter_method', 'filter_method_other',
                        'filter_vol', 'filter_type', 'filter_type_other', 'filter_pore', 
                        'filter_size', 'filter_saturation', 'filter_notes',
                        'created_by', 'created_datetime', 'modified_datetime', )
    ...
    field_sample = fields.Field(
        ...
        widget=ForeignKeyWidget(FieldSample, 'sample_global_id'))
