...
urlpatterns = [
    ...
    path('dashboard/fieldsite/add/', fieldsite_views.FieldSiteCreateView.as_view(), 
        name='add_fieldsite'),
    ...
    # FIELD SURVEY: FIELD SURVEY (VIEW, ADD, UPDATE, IMPORT)
    ...
    path('dashboard/fieldsurvey/fieldsurvey/import/', fieldsurvey_views.FieldSurveyImportView.as_view(), 
         name='import_fieldsurvey'),
    path('dashboard/fieldsurvey/fieldsurvey/update/<str:pk>/', fieldsurvey_views.FieldSurveyUpdateView.as_view(
        success_url=reverse_lazy('view_fieldsurvey')), 
         name='update_fieldsurvey'),
    ...
    # FIELD SURVEY: ENV MEASUREMENT TYPE (VIEW)
    path('dashboard/fieldsurvey/envmeasurementtype/view/', 
        fieldsurvey_views.EnvMeasureTypeFilterView.as_view(
        filterset_class=fieldsurvey_filters.EnvMeasureTypeSerializerFilter), 
        name='view_envmeasuretype'),
    # FIELD SURVEY: ENV MEASUREMENT (VIEW, ADD, UPDATE)
    path('dashboard/fieldsurvey/envmeasurement/view/', fieldsurvey_views.EnvMeasureFilterView.as_view(
        filterset_class=fieldsurvey_filters.EnvMeasureFilter), name='view_envmeasure'),
    path('dashboard/fieldsurvey/envmeasurement/add/', fieldsurvey_views.EnvMeasureCreateView.as_view(), 
         name='add_envmeasure'),
    path('dashboard/fieldsurvey/envmeasurement/update/<str:pk>/', fieldsurvey_views.EnvMeasureUpdateView.as_view(success_url=reverse_lazy('view_envmeasure')), name='update_envmeasure'),
    # FIELD SURVEY: FIELD SAMPLE (VIEW, ADD, UPDATE)
    path('dashboard/fieldsurvey/fieldsample/view/', fieldsurvey_views.FieldSampleFilterView.as_view(
        filterset_class=fieldsurvey_filters.FieldSampleFilter), 
         name='view_fieldsample'),
    path('dashboard/fieldsurvey/fieldsample/import/', fieldsurvey_views.FieldSampleImportView.as_view(), 
        name='import_fieldsample'),
    path('dashboard/fieldsurvey/fieldsample/add/', fieldsurvey_views.FieldSampleCreateView.as_view(), 
         name='add_fieldsample'),
    path('dashboard/fieldsurvey/fieldsample/update/<str:pk>/', 
        fieldsurvey_views.FieldSampleUpdateView.as_view(
        success_url=reverse_lazy('view_fieldsample')), 
        name='update_fieldsample'),
    ...
    path('dashboard/fieldsurvey/filtersample/import/', fieldsurvey_views.FilterSampleImportView.as_view(), 
            name='import_filtersample'),
    ...
    # MIXS
    path('dashboard/mixs/water/view/', wetlab_views.MixsWaterFilterView.as_view(filterset_class=wetlab_filters.MixsWaterFilter), 
         name='view_mixswater'),
